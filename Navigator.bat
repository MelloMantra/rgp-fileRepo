...
echo Type "b" to go back.
SET /p game=Select game: Pokemon Ruby, Kirby NiD, Super Mario World (GBA) : "
PAUSE
if "%game%==Super Mario World (GBA)" goto smwStart
if "%game%==Pokemon Ruby" goto pokemonStart
if "%game%==Kirby NiD" goto kirbyStart
if %game%==b goto consoleQuery
color 04
echo ERROR: User did not enter a valid game name. Please try again.
color 07
...
echo Type "b" to go back.
SET /p game=Select game: Super Mario 64, Mario Kart 64: "
PAUSE
if "%game%==Super Mario 64" goto sm64Start
if "%game%==Mario Kart 64" goto mk64Start
if %game%==b goto consoleQuery
color 04
echo ERROR: User did not enter a valid game name. Please try again.
color 07
