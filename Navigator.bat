@echo off
Assoc .nes=NES_game
Ftype NES_game="C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\Nestopia140bin\nestopia.exe" %1
Assoc .z64=N64_game
Ftype N64_game="C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\Project64\Project64.exe" %1
Assoc .gba=GBA_game
Ftype GBA_game="C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\VisualBoy.exe" %1
Assoc .gbc=GBC_game
Ftype GBC_game="C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\VisualBoy.exe" %1
color 09
echo.
echo      ###############             ###############          ###############
echo      ##            ###         ###             ###        ##            ###
...
cd "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\library\NES\" && start /wait %game%
...
:gbagameStart
echo Launching %game% for the %console%...
cd "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\library\GB\" && start /wait %game%
...
:n64gameStart
echo Launching %game% for the %console%...
cd "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\library\N64\" && start /wait %game%
