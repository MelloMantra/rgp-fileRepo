...
cd "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\library\NES\" && start /wait "Nestopia" "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\Nestopia140bin\nestopia.exe" "%game%"
...
:gbagameStart
echo Launching %game% for the %console%...
cd "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\library\GB\" && start /wait "VisualBoy" "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\VisualBoy.exe" "%game%"
...
:ladxStart
echo Launching %game% for the %console%...
start /wait "VisualBoy" "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\VisualBoy.exe" "%game%"
...
:n64gameStart
echo Launching %game% for the %console%...
start /wait "Project64" "C:\Users\%username%\OneDrive - Chandler Unified School District #80\RetroGamePackage\Starter_Pack\Contents\emuStore\Project64\Project64.exe" "%game%"
